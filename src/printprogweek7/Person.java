...
public class Person {
    ...
    public void setFirstName(String firstname){     //setting firstname
        first = firstname;   } // assigning to another variable to pass on to getFirstName method


    public String getFirstName(){   // calling firstname
        return first;   }       // returning the value to getFullName method


    public void setLastName(String lastname){   //setting lastname
        last = lastname;  }    //assigning to another variable to pass on to getLastName method


    public String getLastName(){     // calling lastname
        return last;   }        // returning the value to getFullName method


    public void setAge(int age){   //setting age criteria and assigning to another variable to pass to getAge method
        if(age <0 || age >100){
            age1 = 0;}
        else {age1 = age;}  }


    public int getAge(int age1){    //calling age
        return age1;   }


    public boolean isTeen(){        // condition to determine teen
